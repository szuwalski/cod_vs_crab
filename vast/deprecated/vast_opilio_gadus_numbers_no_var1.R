...
### We do this based on numbers (not biomass) and REMOVE variation in the 1st predictor ###
### 3/20/19 ###
...
fp = paste0(getwd(),'/vast/output/opilio_gadus_numbers_no_var1/')
dir.create(fp)

model_directory <- paste0(getwd(),'/vast/output/opilio_gadus_numbers_no_var1/model/')
...
# FOR THIS MODEL WE TURN OFF S AND S-T VARIATION IN THE 1ST LINEAR PREDICTOR
FieldConfig = c(Omega1 = 0, Epsilon1 = 0, Omega2 = 5,
                Epsilon2 = 5)
...
# we choose a zero-inflated Poisson distribution for positive catch rates and a conventional delta-model for enc prob
# 
ObsModel = c(11, 0)
